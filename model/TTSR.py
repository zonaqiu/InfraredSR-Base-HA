...
class TTSR(nn.Module):
    def __init__(self, args):
        ...
        self.MainNet = MainNet.MainNet(args=args,num_res_blocks=self.num_res_blocks, n_feats=args.n_feats,
